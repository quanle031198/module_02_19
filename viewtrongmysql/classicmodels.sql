...
-- Thời gian đã tạo: Th4 28, 2021 lúc 09:20 PM
...
-- Thủ tục
--
CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `findAllCustomers` ()  BEGIN

   SELECT *  FROM customers where customerNumber = 175;

END$$

CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `find_customers` (IN `cusnum` INT(11))  BEGIN 
SELECT * from customers WHERE customerNumber = cusnum;
end$$

CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `GetCustomersCountByCity` (IN `in_city` VARCHAR(50), OUT `total` INT)  BEGIN
...
CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `SetCounter` (INOUT `counter` INT, IN `inc` INT)  BEGIN

    SET counter = counter + inc;

END$$

CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `show_customers` ()  BEGIN
SELECT * FROM customers;
END$$

CREATE DEFINER=`phpmyadmin`@`localhost` PROCEDURE `updatePayments` (IN `cusNum` INT, IN `checkNum` VARCHAR(20), IN `payDate` DATE, IN `amou` FLOAT)  BEGIN 
INSERT INTO payments(customerNumber,checkNumber,paymentDate,amount)
VALUE(cusNum,checkNum,payDate,amou);
END$$
...
(103, 'Le Hoang Quan', 'Le', 'Quan ', '40.32.2555', '54, rue Royale', NULL, 'Nantes', NULL, '44000', 'France', 1370, '21000.00'),
...
--
-- Cấu trúc đóng vai cho view `customer_views`
...
(10100, '2003-01-06', '2003-01-13', '2003-01-10', 'cancle', NULL, 363),
(10101, '2003-01-09', '2003-01-18', '2003-01-11', 'Shipped', 'Check on availability.', 128),
(10102, '2003-01-10', '2003-01-18', '2003-01-14', 'cancle', NULL, 181),
(10103, '2003-01-29', '2003-02-07', '2003-02-02', 'Shipped', NULL, 121),
(10104, '2003-01-31', '2003-02-09', '2003-02-01', 'Shipped', NULL, 141),
(10105, '2003-02-11', '2003-02-21', '2003-02-12', 'Shipped', NULL, 145),
(10106, '2003-02-17', '2003-02-24', '2003-02-21', 'Shipped', NULL, 278),
(10107, '2003-02-24', '2003-03-03', '2003-02-26', 'cancle', 'Difficult to negotiate with customer. We need more marketing materials', 131),
(10108, '2003-03-03', '2003-03-12', '2003-03-08', 'Shipped', NULL, 385),
(10109, '2003-03-10', '2003-03-19', '2003-03-11', 'cancle', 'Customer requested that FedEx Ground is used for this shipping', 486),
(10110, '2003-03-18', '2003-03-24', '2003-03-20', 'Shipped', NULL, 187),
(10111, '2003-03-25', '2003-03-31', '2003-03-30', 'cancle', NULL, 129),
...
(10113, '2003-03-26', '2003-04-02', '2003-03-27', 'cancle', NULL, 124),
(10114, '2003-04-01', '2003-04-07', '2003-04-02', 'Shipped', NULL, 172),
(10115, '2003-04-04', '2003-04-12', '2003-04-07', 'cancle', NULL, 424),
...
(10124, '2003-05-21', '2003-05-29', '2003-05-25', 'cancle', 'Customer very concerned about the exact color of the models. There is high risk that he may dispute the order because there is a slight color mismatch', 112),
(10125, '2003-05-21', '2003-05-27', '2003-05-24', 'Shipped', NULL, 114),
(10126, '2003-05-28', '2003-06-07', '2003-06-02', 'Shipped', NULL, 458),
(10127, '2003-06-03', '2003-06-09', '2003-06-06', 'cancle', 'Customer requested special shippment. The instructions were passed along to the warehouse', 151),
(10128, '2003-06-06', '2003-06-12', '2003-06-11', 'Shipped', NULL, 141),
(10129, '2003-06-12', '2003-06-18', '2003-06-14', 'Shipped', NULL, 324),
(10130, '2003-06-16', '2003-06-24', '2003-06-21', 'cancle', NULL, 198),
(10131, '2003-06-16', '2003-06-25', '2003-06-21', 'cancle', NULL, 447),
...
(10135, '2003-07-02', '2003-07-12', '2003-07-03', 'cancle', NULL, 124),
...
(10140, '2003-07-24', '2003-08-02', '2003-07-30', 'cancle', NULL, 161),
(10141, '2003-08-01', '2003-08-09', '2003-08-04', 'Shipped', NULL, 334),
(10142, '2003-08-08', '2003-08-16', '2003-08-13', 'cancle', NULL, 124),
(10143, '2003-08-10', '2003-08-18', '2003-08-12', 'cancle', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 320),
(10144, '2003-08-13', '2003-08-21', '2003-08-14', 'Shipped', NULL, 381),
(10145, '2003-08-25', '2003-09-02', '2003-08-31', 'cancle', NULL, 205),
(10146, '2003-09-03', '2003-09-13', '2003-09-06', 'cancle', NULL, 447),
(10147, '2003-09-05', '2003-09-12', '2003-09-09', 'cancle', NULL, 379),
(10148, '2003-09-11', '2003-09-21', '2003-09-15', 'Shipped', 'They want to reevaluate their terms agreement with Finance.', 276),
(10149, '2003-09-12', '2003-09-18', '2003-09-17', 'cancle', NULL, 487),
...
(10154, '2003-10-02', '2003-10-12', '2003-10-08', 'cancle', NULL, 219),
...
(10159, '2003-10-10', '2003-10-19', '2003-10-16', 'cancle', NULL, 321),
(10160, '2003-10-11', '2003-10-17', '2003-10-17', 'cancle', NULL, 347),
(10161, '2003-10-17', '2003-10-25', '2003-10-20', 'Shipped', NULL, 227),
(10162, '2003-10-18', '2003-10-26', '2003-10-19', 'cancle', NULL, 321),
(10163, '2003-10-20', '2003-10-27', '2003-10-24', 'cancle', NULL, 424),
...
(10166, '2003-10-21', '2003-10-30', '2003-10-27', 'cancle', NULL, 462),
...
(10168, '2003-10-28', '2003-11-03', '2003-11-01', 'cancle', NULL, 161),
...
(10172, '2003-11-05', '2003-11-14', '2003-11-11', 'cancle', NULL, 175),
...
(10182, '2003-11-12', '2003-11-21', '2003-11-18', 'cancle', NULL, 124),
(10183, '2003-11-13', '2003-11-22', '2003-11-15', 'cancle', 'We need to keep in close contact with their Marketing VP. He is the decision maker for all their purchases.', 339),
(10184, '2003-11-14', '2003-11-22', '2003-11-20', 'Shipped', NULL, 484),
(10185, '2003-11-14', '2003-11-21', '2003-11-20', 'cancle', NULL, 320),
...
(10189, '2003-11-18', '2003-11-25', '2003-11-24', 'cancle', 'They want to reevaluate their terms agreement with Finance.', 205),
...
(10192, '2003-11-20', '2003-11-29', '2003-11-25', 'cancle', NULL, 363),
(10193, '2003-11-21', '2003-11-28', '2003-11-27', 'Shipped', NULL, 471),
(10194, '2003-11-25', '2003-12-02', '2003-11-26', 'Shipped', NULL, 146),
(10195, '2003-11-25', '2003-12-01', '2003-11-28', 'cancle', NULL, 319),
(10196, '2003-11-26', '2003-12-03', '2003-12-01', 'cancle', NULL, 455),
...
(10207, '2003-12-09', '2003-12-17', '2003-12-11', 'cancle', 'Check on availability.', 495),
(10208, '2004-01-02', '2004-01-11', '2004-01-04', 'Shipped', NULL, 146),
(10209, '2004-01-09', '2004-01-15', '2004-01-12', 'cancle', NULL, 347),
...
(10215, '2004-01-29', '2004-02-08', '2004-02-01', 'cancle', 'Customer requested that FedEx Ground is used for this shipping', 475),
...
(10226, '2004-02-26', '2004-03-06', '2004-03-02', 'cancle', NULL, 239),
(10227, '2004-03-02', '2004-03-12', '2004-03-08', 'Shipped', NULL, 146),
(10228, '2004-03-10', '2004-03-18', '2004-03-13', 'cancle', NULL, 173),
(10229, '2004-03-11', '2004-03-20', '2004-03-12', 'cancle', NULL, 124),
...
(10233, '2004-03-29', '2004-04-04', '2004-04-02', 'cancle', 'Customer requested special shippment. The instructions were passed along to the warehouse', 328),
(10234, '2004-03-30', '2004-04-05', '2004-04-02', 'Shipped', NULL, 412),
(10235, '2004-04-02', '2004-04-12', '2004-04-06', 'Shipped', NULL, 260),
(10236, '2004-04-03', '2004-04-11', '2004-04-08', 'cancle', NULL, 486),
(10237, '2004-04-05', '2004-04-12', '2004-04-10', 'cancle', NULL, 181),
...
(10242, '2004-04-20', '2004-04-28', '2004-04-25', 'cancle', 'Customer is interested in buying more Ferrari models', 456),
(10243, '2004-04-26', '2004-05-03', '2004-04-28', 'cancle', NULL, 495),
(10244, '2004-04-29', '2004-05-09', '2004-05-04', 'Shipped', NULL, 141),
(10245, '2004-05-04', '2004-05-12', '2004-05-09', 'cancle', NULL, 455),
(10246, '2004-05-05', '2004-05-13', '2004-05-06', 'Shipped', NULL, 141),
(10247, '2004-05-05', '2004-05-11', '2004-05-08', 'Shipped', NULL, 334),
(10248, '2004-05-07', '2004-05-14', NULL, 'cancle', 'Order was mistakenly placed. The warehouse noticed the lack of documentation.', 131),
(10249, '2004-05-08', '2004-05-17', '2004-05-11', 'cancle', 'Can we deliver the new Ford Mustang models by end-of-quarter?', 173),
(10250, '2004-05-11', '2004-05-19', '2004-05-15', 'cancle', NULL, 450),
(10251, '2004-05-18', '2004-05-24', '2004-05-24', 'cancle', NULL, 328),
...
(10257, '2004-06-14', '2004-06-24', '2004-06-15', 'cancle', NULL, 450),
...
(10263, '2004-06-28', '2004-07-04', '2004-07-02', 'cancle', NULL, 175),
(10264, '2004-06-30', '2004-07-06', '2004-07-01', 'cancle', 'Customer will send a truck to our local warehouse on 7/1/2004', 362),
(10265, '2004-07-02', '2004-07-09', '2004-07-07', 'Shipped', NULL, 471),
(10266, '2004-07-06', '2004-07-14', '2004-07-10', 'Shipped', NULL, 386),
(10267, '2004-07-07', '2004-07-17', '2004-07-09', 'cancle', NULL, 151),
...
(10271, '2004-07-20', '2004-07-29', '2004-07-23', 'cancle', NULL, 124),
(10272, '2004-07-20', '2004-07-26', '2004-07-22', 'cancle', NULL, 157),
(10273, '2004-07-21', '2004-07-28', '2004-07-22', 'Shipped', NULL, 314),
(10274, '2004-07-21', '2004-07-29', '2004-07-22', 'cancle', NULL, 379),
(10275, '2004-07-23', '2004-08-02', '2004-07-29', 'Shipped', NULL, 119),
(10276, '2004-08-02', '2004-08-11', '2004-08-08', 'cancle', NULL, 204),
(10277, '2004-08-04', '2004-08-12', '2004-08-05', 'Shipped', NULL, 148),
(10278, '2004-08-06', '2004-08-16', '2004-08-09', 'cancle', NULL, 112),
...
(10281, '2004-08-19', '2004-08-28', '2004-08-23', 'cancle', NULL, 157),
(10282, '2004-08-20', '2004-08-26', '2004-08-22', 'cancle', NULL, 124),
...
(10285, '2004-08-27', '2004-09-04', '2004-08-31', 'cancle', NULL, 286),
...
(10290, '2004-09-07', '2004-09-15', '2004-09-13', 'cancle', NULL, 198),
(10291, '2004-09-08', '2004-09-17', '2004-09-14', 'Shipped', NULL, 448),
(10292, '2004-09-08', '2004-09-18', '2004-09-11', 'cancle', 'They want to reevaluate their terms agreement with Finance.', 131),
(10293, '2004-09-09', '2004-09-18', '2004-09-14', 'Shipped', NULL, 249),
(10294, '2004-09-10', '2004-09-17', '2004-09-14', 'cancle', NULL, 204),
(10295, '2004-09-10', '2004-09-17', '2004-09-14', 'cancle', 'They want to reevaluate their terms agreement with Finance.', 362),
...
(10305, '2004-10-13', '2004-10-22', '2004-10-15', 'cancle', 'Check on availability.', 286),
(10306, '2004-10-14', '2004-10-21', '2004-10-17', 'Shipped', NULL, 187),
(10307, '2004-10-14', '2004-10-23', '2004-10-20', 'cancle', NULL, 339),
(10308, '2004-10-15', '2004-10-24', '2004-10-20', 'cancle', 'Customer requested that FedEx Ground is used for this shipping', 319),
...
(10312, '2004-10-21', '2004-10-27', '2004-10-23', 'cancle', NULL, 124),
...
(10317, '2004-11-02', '2004-11-12', '2004-11-08', 'cancle', NULL, 161),
(10318, '2004-11-02', '2004-11-09', '2004-11-07', 'cancle', NULL, 157),
(10319, '2004-11-03', '2004-11-11', '2004-11-06', 'cancle', 'Customer requested that DHL is used for this shipping', 456),
(10320, '2004-11-03', '2004-11-13', '2004-11-07', 'Shipped', NULL, 144),
(10321, '2004-11-04', '2004-11-12', '2004-11-07', 'cancle', NULL, 462),
(10322, '2004-11-04', '2004-11-12', '2004-11-10', 'cancle', 'Customer has worked with some of our vendors in the past and is aware of their MSRP', 363),
(10323, '2004-11-05', '2004-11-12', '2004-11-09', 'Shipped', NULL, 128),
(10324, '2004-11-05', '2004-11-11', '2004-11-08', 'cancle', NULL, 181),
...
(10329, '2004-11-15', '2004-11-24', '2004-11-16', 'cancle', NULL, 131),
(10330, '2004-11-16', '2004-11-25', '2004-11-21', 'Shipped', NULL, 385),
(10331, '2004-11-17', '2004-11-23', '2004-11-23', 'cancle', 'Customer requested special shippment. The instructions were passed along to the warehouse', 486),
(10332, '2004-11-17', '2004-11-25', '2004-11-18', 'Shipped', NULL, 187),
(10333, '2004-11-18', '2004-11-27', '2004-11-20', 'cancle', NULL, 129),
...
(10335, '2004-11-19', '2004-11-29', '2004-11-23', 'cancle', NULL, 124),
(10336, '2004-11-20', '2004-11-26', '2004-11-24', 'Shipped', 'Customer requested that DHL is used for this shipping', 172),
(10337, '2004-11-21', '2004-11-30', '2004-11-26', 'cancle', NULL, 424),
...
(10346, '2004-11-29', '2004-12-05', '2004-11-30', 'cancle', NULL, 112),
...
(10349, '2004-12-01', '2004-12-07', '2004-12-03', 'cancle', NULL, 151),
(10350, '2004-12-02', '2004-12-08', '2004-12-05', 'Shipped', NULL, 141),
(10351, '2004-12-03', '2004-12-11', '2004-12-07', 'Shipped', NULL, 324),
(10352, '2004-12-03', '2004-12-12', '2004-12-09', 'cancle', NULL, 198),
(10353, '2004-12-04', '2004-12-11', '2004-12-05', 'cancle', NULL, 447),
...
(10357, '2004-12-10', '2004-12-16', '2004-12-14', 'cancle', NULL, 124),
...
(10362, '2005-01-05', '2005-01-16', '2005-01-10', 'cancle', NULL, 161),
(10363, '2005-01-06', '2005-01-12', '2005-01-10', 'Shipped', NULL, 334),
(10364, '2005-01-06', '2005-01-17', '2005-01-09', 'Shipped', NULL, 350),
(10365, '2005-01-07', '2005-01-18', '2005-01-11', 'cancle', NULL, 320),
(10366, '2005-01-10', '2005-01-19', '2005-01-12', 'Shipped', NULL, 381),
(10367, '2005-01-12', '2005-01-21', '2005-01-16', 'cancle', 'This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedEx\'s investigation proved this wrong.', 205),
(10368, '2005-01-19', '2005-01-27', '2005-01-24', 'cancle', 'Can we renegotiate this one?', 124),
(10369, '2005-01-20', '2005-01-28', '2005-01-24', 'cancle', NULL, 379),
(10370, '2005-01-20', '2005-02-01', '2005-01-25', 'Shipped', NULL, 276),
(10371, '2005-01-23', '2005-02-03', '2005-01-25', 'cancle', NULL, 124),
...
(10376, '2005-02-08', '2005-02-18', '2005-02-13', 'cancle', NULL, 219),
...
(10381, '2005-02-17', '2005-02-25', '2005-02-18', 'cancle', NULL, 321),
(10382, '2005-02-17', '2005-02-23', '2005-02-18', 'cancle', 'Custom shipping instructions sent to warehouse', 124),
(10383, '2005-02-22', '2005-03-02', '2005-02-25', 'Shipped', NULL, 141),
(10384, '2005-02-23', '2005-03-06', '2005-02-27', 'cancle', NULL, 321),
(10385, '2005-02-28', '2005-03-09', '2005-03-01', 'cancle', NULL, 124),
...
(10388, '2005-03-03', '2005-03-11', '2005-03-09', 'cancle', NULL, 462),
(10389, '2005-03-03', '2005-03-09', '2005-03-08', 'Shipped', NULL, 448),
(10390, '2005-03-04', '2005-03-11', '2005-03-07', 'cancle', 'They want to reevaluate their terms agreement with Finance.', 124),
...
(10396, '2005-03-23', '2005-04-02', '2005-03-28', 'cancle', NULL, 124),
...
(10400, '2005-04-01', '2005-04-11', '2005-04-04', 'cancle', 'Customer requested that DHL is used for this shipping', 450),
(10401, '2005-04-03', '2005-04-14', NULL, 'cancle', 'Customer credit limit exceeded. Will ship when a payment is received.', 328),
...
(10407, '2005-04-22', '2005-05-04', NULL, 'cancle', 'Customer credit limit exceeded. Will ship when a payment is received.', 450),
...
(10413, '2005-05-05', '2005-05-14', '2005-05-09', 'cancle', 'Customer requested that DHL is used for this shipping', 175),
(10414, '2005-05-06', '2005-05-13', NULL, 'cancle', 'Customer credit limit exceeded. Will ship when a payment is received.', 362),
...
(10421, '2005-05-29', '2005-06-06', NULL, 'cancle', 'Custom shipping instructions were sent to warehouse', 124),
(10422, '2005-05-30', '2005-06-11', NULL, 'cancle', NULL, 157),
...
--
-- Cấu trúc đóng vai cho view `view_customer`
-- (See below for the actual view)
--
...
--
-- Cấu trúc cho view `customer_views`
--
...
--
-- Cấu trúc cho view `view_customer`
--
DROP TABLE IF EXISTS `view_customer`;

CREATE ALGORITHM=UNDEFINED DEFINER=`phpmyadmin`@`localhost` SQL SECURITY DEFINER VIEW `view_customer`  AS  select `c`.`customerName` AS `customerName`,`c`.`contactLastName` AS `contactLastName`,`c`.`country` AS `country`,`o`.`status` AS `status`,`o`.`orderDate` AS `orderDate` from (`customers` `c` join `orders` `o` on(`c`.`customerNumber` = `o`.`customerNumber`)) where `c`.`country` = 'USA' WITH CASCADED CHECK OPTION ;
