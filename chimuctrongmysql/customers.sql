...
-- Thời gian đã tạo: Th4 28, 2021 lúc 03:58 PM
...
(103, 'Atelier graphique12', 'Schmitt', 'Carine ', '40.32.2555', '54, rue Royale', NULL, 'Nantes', NULL, '44000', 'France', 1370, '21000.00'),
...
ALTER TABLE `customers`
  ...
  ADD KEY `idx_customerNumber` (`customerNumber`),
  ADD KEY `idx_full_name` (`contactFirstName`,`contactLastName`);
